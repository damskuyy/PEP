<section id="testimonials" class="testimonials section-bg">
    <div class="container py-5 mb-5" data-aos="fade-up">
        <div class="section-header">
            <h2>Klien Kami</h2>
            <p>Klien kami berasal dari berbagai industri, mempercayakan proyek penting kepada kami karena layanan profesional, solusi efektif, dan hasil yang memuaskan.</p>
        </div>
        <div class="mt-5 client-carousel-container">
